 ...
 */
public class Soluation_161989 {
	public static void main(String[] args) {
		int wallLength = 5;
		int rollerLength = 4;
		int[] section = new int[] { 1, 3 };

		System.out.println(run(wallLength, rollerLength, section));
	}

	/**
	 * @param n       : 벽의 길이
	 * @param m       : 롤러의 길이
	 * @param section : 페인트 칠 해야하는 구역
	 */
	private static int run(int wallLength, int rollerLength, int[] section) {

		int start = section[0];
		int end = section[0] + (rollerLength - 1);
		int answer = 1;
