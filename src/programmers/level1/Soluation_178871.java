 ...
 * 2등인 "soe" 선수가 1등인 "mumu" 선수를 추월했다는 것입니다. 즉 "soe" 선수가 1등, "mumu" 선수가 2등으로
 * 바뀝니다.
 * 
 ...
 */
public class Soluation_178871 {
	public static void main(String[] args) {
		String[] players = { "mumu", "soe", "poe", "kai", "mine" };
		String[] callings = { "kai", "kai", "mine", "mine" };
		run(players, callings);
	}

	private static void run(String[] players, String[] callings) {
		...
		for (String calling : callings) {
			...
			playersMap.put(called, rank - 1);
			playersMap.put(front, rank);
		}
