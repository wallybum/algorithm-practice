 ...
 * 파일들은 바탕화면의 격자칸에 위치하고 바탕화면의 격자점들은 바탕화면의 가장 왼쪽 위를
 * (0, 0)으로 시작해 (세로 좌표, 가로 좌표)로 표현합니다.
 ...
 */
public class Soluation_161990 {
	public static void main(String[] args) {
		String[] wallpaper = new String[] { "..........", ".....#....", "......##..", "...##.....", "....#....." };
		System.out.println(run(wallpaper));
	}

	private static int[] run(String[] wallpaper) {
		int minRow, minCol;
		int maxRow, maxCol;
